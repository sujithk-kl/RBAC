  ...
  <div
    ...
    } w-64 bg-gray-800 p-9 text-white fixed inset-0 z-50 md:block`}
  >
    <button
    ...
    <ul className="space-y-9">
      ...
      <li>
        ...
        <div className="flex-1 ml-64 p-8 bg-gradient-to-r from-blue-900 via-green-800 to-teal-700">
          ...
          <div className="w-full max-w-8xl p-8 bg-gradient-to-br from-[#2c3e50] via-[#34495e] to-[#16a085] rounded-3xl shadow-2xl">
            <h2 className="text-4xl font-extrabold text-center text-white mb-8">
              Manager Dashboard
            </h2>

            {message && (
              <div className="mb-4 p-3 bg-red-100 text-green-800 rounded">
                {message}
              </div>
            )}
